...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_orders_a172275, tbl_staffs_a172275_pt2,
      tbl_customers_a172275_pt2, tbl_orders_details_a172275 WHERE
      tbl_orders_a172275.fld_staff_id = tbl_staffs_a172275_pt2.fld_staff_id AND
      tbl_orders_a172275.fld_customer_id = tbl_customers_a172275_pt2.fld_customer_id AND
      tbl_orders_a172275.fld_order_num = tbl_orders_details_a172275.fld_order_num AND
      tbl_orders_a172275.fld_order_num = :oid");
  ...
  <div class="col-xs-5">
    ...
    <div class="col-xs-5 col-xs-offset-2 text-right">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
        <p>
        MCT Tower Sky Park, <br>
        Jalan USJ 25/1, <br>
        46200 Subang Jaya, <br>
        Selangor <br>
        </p>
            </div>
        </div>
...
<table class="table table-bordered">
  ...
  try {
    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
      $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a172275,
        tbl_products_a172275_pt2 where 
        tbl_orders_details_a172275.fld_product_num = tbl_products_a172275_pt2.FLD_PRODUCT_ID AND
        fld_order_num = :oid");
    $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
      $oid = $_GET['oid'];
    $stmt->execute();
